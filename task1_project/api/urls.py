...
urlpatterns = [
    ...
    path(
        'redoc/', SchemaView.with_ui('redoc', cache_timeout=0),
        name='schema-redoc'),
    path(
        'swagger/', SchemaView.with_ui('swagger', cache_timeout=0),
        name='schema-swagger-ui'),
    re_path(
    ...
    path(
        'chain/statictic/', views.get_chains_by_gt_avg_debt,
        name='gt_avg_debt'),
    path(
        'product/<int:product_id>/contacts/',
        views.get_chain_contacts_by_product_id,
